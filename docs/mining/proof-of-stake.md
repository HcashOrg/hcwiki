# <img class="hc-icon" src="/img/hc-icons/TicketVoted.svg" /> Proof-of-Stake (PoS) Mining
...
HC's unique Proof-of-Stake protocol serves multiple purposes:

1. Allowing stakeholders to vote for or against proposed changes to the HC blockchain. If stakeholders vote in support of a change, the chain will hardfork and the new feature becomes active automatically. More information on voting can be found in the [Mainnet Voting Guide](/getting-started/user-guides/agenda-voting.md).
...
1. Allowing long-term holders of HC to lock up their funds for a length of time in order to accrue new coins from the [Block Reward](/advanced/inflation/).
