...
Visit [https://github.com/HcashOrg](https://github.com/HcashOrg) to download the gominer binaries. Within the "Downloads" section you should see the following files:
...
If this is new to you, here are a few guides for creating workers on some of the HC mining pools.
...
- set `pool=` to the stratum+tcp address:port of the mining pool of your choice, e.g. HCpool.org uses `stratum+tcp://stratum.HCpool.org:3333` (WARNING: the http://address:port will not work with gominer - stratum+tcp *must* be used).
