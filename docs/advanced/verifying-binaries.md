# <img class="hc-icon" src="/img/hc-icons/Code.svg" /> Verifying Binaries 

---

The official
[HC releases](https://github.com/HcashOrg) have
...
In order to verify binaries or other signed files from the HC
...
the zip/tarball for your OS from [here](https://github.com/HcashOrg). Obtain the SHA256 value for the
...
Import the HC Release Signing Key in GnuPG.  You will only need to
...
gpg: key 7608AF04: public key "HC Release <release@HC.org>" imported
...
gpg: Good signature from "HC Release <release@HC.org>"
...
you can be confident they were generated by the HC Project.
