# <img class="dcr-icon" src="/img/dcr-icons/Constitution.svg" /> HC Constitution
...
* *Fixed Finite Supply* - Issuance is finite and the total maximum number of coins in *HC* shall not change. The total maximum supply for *HC* is 40,650,286.40797817 coins, with a per-block subsidy that adjusts every 12,888 blocks (approximately 21.33 days) by reducing by a factor which is approximately equal to 999/1000. The genesis block subsidy starts at 6.4 coins.
