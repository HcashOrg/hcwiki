...
[hcexplore](https://github.com/coolsnady/hcexplorer) is located at
[`https://hc-explorer.h.cash`](https://explorer.hcexplore.org) or
[`https://testnet-explorer.h.cash`](https://testnet.hcexplore.org).
* The explorer based on
[insight](https://github.com/bitpay/insight-ui) is located at
[`https://mainnet.h.cash`](https://mainnet.h.cash) or 
[`https://testnet.h.cash`](https://testnet.h.cash).
...
Here’s the information included in standard HC transactions.
...
Note `Received Time`, `Mined Time`, and `Included in Block` will not have a value until a miner validates the transaction and includes it in a HC block. After being confirmed in a block, the transaction is considered complete.
